...
def method_comparison(results_file,name,dontplot=[],rangess=None,Jranges=None,MNL=[5,5]):
	results = np.genfromtxt(results_file) #usernotes: load para result_file
	labels = [r'Fudge v1','ItTC','O2GF','AvGF',r'Fudge v2','CAA','SAA',r'Fit']
	f = plt.figure(figsize=(4.,2.))

	a=[plt.subplot2grid((2,4),(i,0),colspan=3,rowspan=1) for i in range(2)] #usernotes: add plt.show(), then plot a up-down sub-2 figure
	...
	times = results.T[0] #usrnotes: transfit, i.e. original column/y
