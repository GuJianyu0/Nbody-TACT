...
for l in s:
  ...
  if "GSLPATH" in l and GSLPath=="":
    GSLPath=l[9:].replace('\n', '')
  if "LAPACKPATH" in l:
    LapackPath=l[12:].replace('\n', '')
  if "TORUSPATH" in l:
    TorusPath=l[10:].replace('\n', '')
  if "EBFPATH" in l:
    EBFPath=l[8:].replace('\n', '')
  if "BOOSTINCPATH" in l:
    BoostPath=l[14:].replace('\n', '')
print "GSLPath:",GSLPath
print "LapackPath:",LapackPath
print "TorusPath:",TorusPath
print "EBFPath",EBFPath
print "BoostPath",BoostPath
if GSLPath=="":
