...
/// Fits Staeckel potential to region (that, 后面定语) a given orbit probes(探测感知, 指给定轨道所探测区域的"Stackel"势)
/// and finds actions in this best-fitting potential
//============================================================================
...
class Stackel_Fitted_Potential: public StackelOblate_PerfectEllipsoid{// 3fit??
    private:
        const int DATAPOINTS = 40; /*< Number of gridpoints 网格点数       */
        const int STEPMAX = 300;   /*< Max number of integrations       */
        const int NMAX = 10;       /*< Number of bisections(二等分) to perform */
        ...
        Potential_JS *TruePot;     /*< Target potential 真实的目标势           */
    ...
    public:
        ...
        */
        ...
        Potential_JS *potential(void){return TruePot;} //只是返回私有; 这样有{return ...}的不光是声明
