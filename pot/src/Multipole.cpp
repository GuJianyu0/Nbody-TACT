...
// =====
// ============================================================================
// Triaxial potential code -- see Section 2.5.3 of BT08 //gjy note: ellipsoidal
// ============================================================================
    ...
    axisymmetric(axisymmetric), triaxial(triaxial), flip(flip), err(err), vocal(vocal)
{
    ...
    dPhi_grid=Phi_grid;
    fillPhigrid();
    std::cout<<"class MultipoleExpansion initialize ... done.\n";//gjy note
}
...
void MultipoleExpansion::fillPhigrid(){ //gjy note: target Phi <- Phi grid <- rho_grid -< rholm_s <- density <- certain potential
...
double MultipoleExpansion::Phi(const VecDoub& x, int coor){
	// std::cout<<"PotentialFormulaMultipole ";
...
VecDoub MultipoleExpansion::Forces(const VecDoub& x, int coor){
